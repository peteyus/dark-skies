...
export class BortleComponent {
  bortles: Record<number, Bortle> = {
    ...
    9: { class: 9, name: 'Inner City', description: 'Bright skies over a large inner city.', example: 'The neon lights and busy motion of Las Vegas, Nevada earn a Bortle rating of 9.'}
  }
